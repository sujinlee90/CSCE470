...
class Recommender():
    ...
    def print_user_mentions_tvshow(self, tv_show):
        ...
        for i in range(0,10):
            print 'User:', self.tweet_text[tvshow_index][i]['user'], ', Text:', self.tweet_text[tvshow_index][i]['text'].encode('utf-8')
    ...
    def recommend_tvshows(self, tv_show):
        ...
        for i in sorted(dic_tvshows.iteritems(), key = operator.itemgetter(1), reverse = True)[:5]:
            print i
